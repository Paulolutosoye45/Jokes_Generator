...
function clearAll() {
  ...
  const jokesContainer = document.querySelector('.joke-content')
...
function showJoke() {
  ...
  jokesContainer.appendChild(newp)
}
...
function showRiddle() {
  ...
  answerP.textContent = 'The answer : ' +  answer
  answerP.hidden = true
  console.log(answerP)
  const riddleContainer = document.querySelector('.riddle-content')
...
function revealAnswers() {
   ...
   if (riddle  && answer.hidden ) {
    ...
    alert ('The is no riddle to reveal the answer to!')
   }
}
